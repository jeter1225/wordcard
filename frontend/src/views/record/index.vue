<template>
  <div>
    <div>
      <h1 style="font-size: 40px; font-family:Microsoft JhengHei; padding-left: 50px;">考試紀錄</h1>
    </div>
      ...
      <el-col :span="8">
        <div class="record_left">
          ...
          <el-row v-for="(id, index) in testList" :key="index">
            <div @click="deliverQuestionList(id.questionList)">
              <el-button
                @click="deliverQuestionList(id.questionList)"
                style="width:75%; font-size: 25px; font-family:Microsoft JhengHei; margin-left:50px; text-align:left;"
                icon="el-icon-price-tag"
                type="warning"
                plain
              >{{id.wordcardName}}</el-button>
            </div>
          </el-row>
        </div>
      </el-col>
